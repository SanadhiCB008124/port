...
import bannerImg1 from "../assets/600.jpg";
import bannerImg2 from "../assets/image.png";
import bannerImg3 from "../assets/jungkook.jpg";

const imageArray = [bannerImg1, bannerImg2, bannerImg3];
const textArray = ["Game Development","Web Development" , "Mobile Development"]
const Hero = () => {
  ...
  return (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}   `}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        <img src={image} alt="billing" className="w-[600px] h-[600px] relative z-[5]" />
